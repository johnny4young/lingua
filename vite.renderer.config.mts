...
export default defineConfig({
  plugins: [shellCspPlugin(), nodeTypingChunkPlugin(),react(), copyRuntimeAssetsPlugin()],
  define: {
  ...
  // VITE_* values across all build configs (renderer, web, main). Pin this
  // independently of the bundler's working directory so packaged builds keep
  // the public license key and other production environment substitutions.
  envDir: __dirname,
  server: {
    watch: {
      ignored: [
