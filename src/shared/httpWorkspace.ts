/**
 * HTTP workspace validation and behavioral implementation.
 *
 * The dependency-safe request/response shapes, limits, enums, and blank
 * request factory live in `httpWorkspaceSchema.ts`. This module preserves the
 * historical public facade while owning parsers, auth composition, query
