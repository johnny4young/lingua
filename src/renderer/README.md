...
| [`components/Debugger/`](components/Debugger)             | `DebuggerDrawer.tsx`, `DebuggerBreakpointList.tsx`, `DebuggerWatchList.tsx` | JS/TS pause controls, breakpoint modes, bounded watches, and paused-frame display |
...
| [debuggerStore.ts](stores/debuggerStore.ts) | persisted breakpoint modes/watch expressions plus session-only paused frames and results |
