 ...
 * pill ("what engine": Worker / Node / Browser preview). Only mounted
 * for languages with runtime modes (JS/TS). Extracted verbatim.
 */

import type { ReactNode } from 'react';
import { useTranslation } from 'react-i18next';
import { ChevronDown, Globe, Package, Terminal } from 'lucide-react';
