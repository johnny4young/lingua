/**
 * RL-121 — React subscription hooks for the active tab.
 *
 ...
 * mutates. This removes the O(N·M) re-render fan-out RL-121 targets,
...
/**
 * RL-121 fold A — subscribe to just the active tab's id. Use this in
