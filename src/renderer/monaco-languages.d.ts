/**
 * Type declarations for Monaco's basic-language Monarch modules.
 * These ESM files export a `conf` (language configuration) and a `language`
 * (Monarch tokenizer definition) but ship without declaration files.
 */
