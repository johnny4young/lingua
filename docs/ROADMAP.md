...
5. **Product quality and supportability.** `RL-088` closed 2026-05-06 (axe-core gate via `tests/e2e/a11y.spec.ts`, keyboard-only flows, OverlayBackdrop focus restoration, plus the `docs/A11Y.md` manual checklist). Remaining: `RL-086` (performance budgets), `RL-089` (profile backup/restore), `RL-090` (recovery UX).
...
<details>
<summary><strong>57 `Done` tickets</strong> — expand for the list</summary>
...
`RL-082`, `RL-083`, `RL-084`, `RL-085`, `RL-087`, `RL-088`, `RL-091`, `RL-092`.
