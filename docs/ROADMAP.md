...
| [`RL-070`](./PLAN.md#rl-070-beautify--minify-suite-and-code-conversion-bundle) | Beautify / minify suite + code-conversion | `Partial` | JSON + JavaScript shipped 2026-04-21. HTML beautify (Prettier) + whitespace-only HTML minify shipped on 2026-04-23 (preserves pre / textarea / script / style verbatim). Remaining: CSS, SCSS, LESS, XML; JS → terser minifier; code-conversion bundle (HTML→JSX, SVG→CSS, cURL→Code). |
