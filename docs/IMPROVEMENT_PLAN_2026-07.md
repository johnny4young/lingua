...
Deudas: tres componentes renderer aún superan 800 LOC; 0 coverage
...
| **Mantenibilidad** | ★★★★ | Docs vivos + gates fuertes; fileSystem y siete componentes prioritarios ya se partieron con budgets automatizados. Quedan tres componentes de 800+ LOC y los hooks grandes de A5. | A2, A5-A7 |
