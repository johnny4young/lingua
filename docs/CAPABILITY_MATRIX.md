...
| Debugger (Rust)        | Out          | Out                 | Out          | Planned (lldb) | — | Desktop native | Rust debugging remains planned and requires a compatible host lldb adapter plus an explicit process/permission lifecycle |
