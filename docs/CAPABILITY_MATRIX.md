...
| Debugger (Go / Rust)   | Out          | Out                 | Out          | Planned (Delve / lldb) | — | Desktop native | implementation (Go via Delve JSON-RPC) and implementation (Rust via lldb-mi) in internal Both require host toolchain installs |
