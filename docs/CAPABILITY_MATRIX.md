...
| JS/TS runtime: Browser preview | Planned (RL-019 Slice 3) | Planned (RL-019 Slice 3) | Out | Planned (RL-019 Slice 3) | — | Browser interpreter | Iframe-isolated context with DOM. Output renders in a dedicated preview pane (planned for Slice 3). Selector renders disabled in Slice 1 |
