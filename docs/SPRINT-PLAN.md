...
|------|--------|:------:|-------|
| Iter 1 | [`RL-068`](./ROADMAP.md) · [`RL-072`](./ROADMAP.md) (QR Code) + [`RL-071`](./ROADMAP.md) (JWT verify+sign + ES/PS families) + [`RL-070`](./ROADMAP.md) (HTML Beautify/Minify) + [`RL-068`](./ROADMAP.md) (Backslash Escape/Unescape) all shipped 2026-04-23 | Shipped | Expand Developer Utilities to DevUtils parity — QR Code generate; JWT Decode/Verify/Sign modes covering all 10 JWS algorithms (HS256/384/512 + RS256 + ES256/384/512 + PS256/384/512); HTML Beautify/Minify (Prettier + whitespace-only minifier with pre/textarea/script/style preservation); Backslash Escape/Unescape (JS / JSON / Python / SQL-MySQL presets). See §3 for the closing summary. |
