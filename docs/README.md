...
| [`RUNTIME_MODES_ADR.md`](./RUNTIME_MODES_ADR.md)   | Per-tab JS/TS runtime modes (Worker / desktop Node / Browser preview); Worker default + disabled-with-tooltip UX for the future two                          | `RL-019`                                                   |
