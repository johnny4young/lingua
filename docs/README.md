...
| [`LOCAL_AI_ADR.md`](./LOCAL_AI_ADR.md)             | Local/hybrid AI — BYO-API-key "Explain this error", strict consent + no-silent-network posture, redaction; product decision + pure request-builder core | `T19` / `RL-031`                                           |
...
| Deep project review — security/bugs/perf/architecture findings + world-class roadmap (2026-07)                                            | [`DEEP_REVIEW_2026_07.md`](./DEEP_REVIEW_2026_07.md)                                             |
| H2 2026 implementation plan — PR merge order, prioritized backlog with per-item designs, execution phases                                 | [`ROADMAP_2026_H2.md`](./ROADMAP_2026_H2.md)                                                     |
