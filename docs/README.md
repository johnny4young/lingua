...
- [`AGENT_INTEGRATION.md`](./AGENT_INTEGRATION.md) — portable `lingua-verify` Agent Skill, native Claude marketplace, client installation, CLI evidence workflow, and execution boundary.
