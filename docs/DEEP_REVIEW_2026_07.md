...
| A5 | Medio | 10 componentes de 800+ líneas violan la regla propia de 250-300 | ✅ Corregido (8 prioritarios; 2 pendientes) |
...
catálogo/filtro a `settingsRailModel` (165). El inventario de componentes sobre
800 LOC bajó de 10 a 2.
`tests/docs/deepReviewMaintainability.test.ts` fija 800 para los padres
completados y budgets de 150-400 para los módulos nuevos; los dos restantes
