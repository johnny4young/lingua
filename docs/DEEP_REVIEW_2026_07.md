...
| A5 | Medio | 10 componentes de 800+ líneas violan la regla propia de 250-300 | ✅ Corregido (7 prioritarios; 3 pendientes) |
...
`HttpRequestBuilderTabs` (273). El inventario de componentes sobre 800 LOC bajó
de 10 a 3.
`tests/docs/deepReviewMaintainability.test.ts` fija 800 para los padres
completados y budgets de 300-400 para los módulos nuevos; los tres restantes
