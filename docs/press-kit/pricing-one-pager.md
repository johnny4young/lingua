...
| --------- | ----- | -------- | ------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Free      | $0    | forever  | Trying Lingua, single-file scratchpads      | 1 open tab at a time, up to 5 saved snippets, JavaScript / TypeScript / Python / Ruby runners, Monaco editor + syntax highlighting, built-in single-shot developer utilities, keyboard shortcut editor, theme preset import/export, full app shell |
...
| --------- | ------ | ---------- | -------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Free      | $0     | siempre    | Probar Lingua, scratchpads de un solo archivo            | 1 pestaña a la vez, hasta 5 snippets guardados, runners de JavaScript / TypeScript / Python / Ruby, editor Monaco + resaltado de sintaxis, utilidades integradas de una sola acción, editor de atajos, import/export de presets de tema, shell completo de la app                             |
