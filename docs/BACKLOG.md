...
- [infra] Auto-update staging channel. Public readiness audit (2026-05-07) recommends a draft/prerelease feed validation path before stable users see a desktop update. Needs acceptance around feed isolation, rollback, and how the update server discovers staging releases. AC still TBD. — 2026-05-07 (jy)
...
- [infra] Signed Windows public release readiness. Decide Authenticode certificate strategy, configure `WIN_CERT_FILE` / `WIN_CERT_PASSWORD`, verify Squirrel installer signing, and run update smoke on a Windows VM before public Windows release. AC still TBD. — 2026-05-07 (jy)
...
- [perf] Startup and memory-leak launch budget. Extend RL-086 beyond bundle sizes into cold start to editor-ready, first interaction, first JS/TS/Python run, and repeated-run memory drift thresholds. AC still TBD. — 2026-05-07 (jy)
