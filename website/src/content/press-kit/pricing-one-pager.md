...
| --------- | ----- | -------------- | ------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Free      | $0    | forever        | Trying Lingua across core languages         | 3 open tabs at a time, up to 5 saved snippets, JavaScript / TypeScript / Python / Ruby runners, Monaco editor + syntax highlighting, built-in single-shot developer utilities, HTTP and SQL workspaces, keyboard shortcut editor, theme preset import/export, full app shell           |
| Monthly   | $5    | / month        | Developers running real multi-language work | Everything in Free plus unlimited tabs and snippets, Go and Rust runners, TypeScript / Python / SQL notebooks, local-first bring-your-own-key AI, persistent execution history, utility workflows with saved history and pipelines, and every update while subscribed. Cancel anytime. |
| Pro       | $59   | one-time       | Developers who prefer to pay once           | Same paid entitlements as Monthly without a recurring subscription.                                                                                                                                                                                                                    |
| Team      | $3    | / seat / month | Teams and agencies                          | Same paid entitlements as Pro, plus seat management and invoicing.                                                                                                                                                                                                                     |
...
| --------- | ------ | --------------- | -------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Free      | $0     | siempre         | Probar Lingua con los lenguajes principales              | 3 pestañas a la vez, hasta 5 snippets guardados, runners de JavaScript / TypeScript / Python / Ruby, editor Monaco + resaltado de sintaxis, utilidades integradas de una sola acción, workspaces HTTP y SQL, editor de atajos, import/export de presets de tema, shell completo de la app.                                              |
| Mensual   | $5     | / mes           | Desarrolladores que ejecutan trabajo multi-lenguaje real | Todo lo de Free más pestañas y snippets ilimitados, runners de Go y Rust, notebooks de TypeScript / Python / SQL, IA local-first con tu propia clave, historial de ejecución persistente, workflows de utilidades con historial guardado y pipelines, y cada actualización mientras la suscripción esté activa. Cancela cuando quieras. |
...
| Team      | $3     | / asiento / mes | Equipos y agencias                                       | Los mismos entitlements de pago que Pro, más gestión de asientos y facturación.                                                                                                                                                                                                                                                         |
