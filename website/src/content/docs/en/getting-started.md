...
- macOS — Apple Silicon and Intel dmg installers; updater zips stay attached as metadata.
- Windows — an x64 NSIS `.exe`. Preview builds may be unsigned and show SmartScreen.
- Linux — an x86_64 AppImage.
