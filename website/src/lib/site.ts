...
export const SITE = {
  ...
  description:
    'Lingua runs JavaScript, TypeScript, Python, Ruby, Go, and Rust in one offline-first desktop app. Monaco editor, Vim mode, 31 built-in dev utilities. Source-available.',
