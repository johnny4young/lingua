/**
 * Tauri spike decision guard — this test fails CI if anyone strips
...
const ADR_PATH = resolve(__dirname, '../../docs/TAURI_SPIKE_ADR.md');
...
describe('TAURI_SPIKE_ADR.md', () => {
  ...
  it('enumerates the proposed measurement axes so the trade-off is inspectable', () => {
    for (const axis of [
      'Cold start',
      'Bundle size',
      'Update/signing path',
