...
<html lang="en">
  <head>
    ...
    <title>Lingua rich console implementation visual matrix</title>
    <style>${pageStyles}</style>
  </head>
  <body>
    <main>
      <header>
        <h1>Rich console implementation visual matrix</h1>
        <p>
          Generated by <code>tests/e2e/richConsoleimplementation.spec.ts</code>.
          Regenerate with <code>pnpm run test:e2e:web -- tests/e2e/richConsoleimplementation.spec.ts</code>.
        </p>
        <pre>open output/playwright/rich-console-gallery.html</pre>
      </header>
